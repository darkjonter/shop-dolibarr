    ...
    <div class="row">
        <aside class="question col-12 col-lg-3 border-right">
            ...
            <div class="faqs">
                ...
                <a href="centro_de_ayuda/Estado_pedido.php" class="font-weight-bold ml-4 faqs-question d-block mb-4 border-bottom">Estado de mi pedido</a>
        ...
        <div class="answers col-12 col-lg-9">
            <h3 class="title-answers border-bottom pb-4 font-weight-bold">ESTADO DE MI PEDIDO</h3>
            <div class="frecuentes mt-4">
                
                <button class="accordion shadow">¿En dónde esta mi pedido?</button>
                <div class="panel">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
    
                <button class="accordion shadow">¿Qué significa el estatus de mi pedido?</button>
                <div class="panel">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
                ...
                <div class="panel">
                 ...
                 <button class="accordion shadow">¿Qué hago si ya realicé mi pago y no he recibido el correo de confirmación?</button>
                <div class="panel">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
            </div>
