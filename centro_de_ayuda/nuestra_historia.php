...
<div class="container mt-5 mb-5">
    <div class="row">
        <aside class="question col-12 col-lg-3 border-right">
            ...
            <div class="faqs">
                <a href="#" class="faqs-question d-block mb-4 border-bottom">Como comprar</a>
                <a href="#" class="faqs-question d-block mb-4 border-bottom">Estado de mi pedido</a>
                <a href="#" class="faqs-question d-block mb-4 border-bottom">Formas de pago</a>
                <a href="#" class="faqs-question d-block mb-4 border-bottom">Envio y entrega</a>
                <a href="#" class="faqs-question d-block mb-4 border-bottom">Reembolsos</a>
            </div>
        </aside>
