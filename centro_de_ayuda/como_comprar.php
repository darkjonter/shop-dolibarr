...
<div class="container mt-5 mb-5">
    <div class="row">
        <aside class="question col-12 col-lg-3 border-right">
            ...
            <div class="faqs">
                 <a href="centro_de_ayuda/como_comprar.php" class="faqs-question font-weight-bold ml-4 d-block mb-4 border-bottom">Como comprar</a>
        ...
        <div class="answers col-12 col-lg-9">
            ...
            <div class="frecuentes mt-4">
                ...
                <button class="accordion shadow">¿Cómo encuentro mi proucto?</button>
                <div class="panel">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
    
                <button class="accordion shadow">¿Cómo se si hay unidades disponibles ?</button>
                <div class="panel">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
    
                <button class="accordion shadow">¿Qué hago si no encuentro mi prducto?</button>
                <div class="panel">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
            </div>
