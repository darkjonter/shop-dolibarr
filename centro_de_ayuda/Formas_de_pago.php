    ...
    <div class="row">
        <aside class="question col-12 col-lg-3 border-right">
            ...
            <div class="faqs">
                ...
                <a href="centro_de_ayuda/Formas_de_pago.php" class="faqs-question font-weight-bold ml-4 d-block mb-4 border-bottom">Formas de pago</a>
        ...
        <div class="answers col-12 col-lg-9">
            <h3 class="title-answers border-bottom pb-4 font-weight-bold">FORMAS DE PAGO</h3>
            <div class="frecuentes mt-4">
                
                <button class="accordion shadow">¿Es seguro pagar Online con ASEOTALCA?</button>
                <div class="panel">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
    
                <button class="accordion shadow">¿Puedo usar mas de una tarjeta de crédito para realizar el pago?</button>
                <div class="panel">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
    
                <button class="accordion shadow">¿Que hacer si no funciona mi pago con tarjeta?</button>
                <div class="panel">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
                
                 <button class="accordion shadow">¿Las formas de pago aplican para todos los productos?</button>
                <div class="panel">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
    
                <button class="accordion shadow">No se ejecuta la orden</button>
                <div class="panel">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
